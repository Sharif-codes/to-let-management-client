...
//     e.preventDefault()
//     const monthText= e.target.monthText.value
//     const monthSmaller= monthText.toLowerCase()
//     console.log(monthSmaller);
//     const filteredMonth= data.filter(item=>item.month.toLowerCase() ===monthSmaller)
...
//           </thead>
//           <tbody>
//             {month?.map((payment, idx) => (
//               <PaymentTable key={idx} index={idx} data={payment}></PaymentTable>
//             ))}
//           </tbody>
//         </table>
//       </div>
